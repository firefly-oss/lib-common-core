...
/**
 * Auto-configuration for lib-transactional-engine integration with lib-common-core.
 * 
...
@ConditionalOnClass(name = {
    ...
    "com.firefly.transactional.events.StepEventPublisher"
})
...
public class TransactionalEngineAutoConfiguration {
    ...
    public TransactionalEngineAutoConfiguration() {
        log.info("Enabling lib-transactional-engine integration with lib-common-core");
    }
}