...
import com.firefly.common.core.config.TransactionFilter;
import com.firefly.common.core.messaging.MessageHeaders;
import com.firefly.common.core.messaging.annotation.HeaderExpression;
...
public class PublishResultAspect {
     ...
     */
    @Around("@annotation(com.firefly.common.core.messaging.annotation.PublishResult)")
