...
public class EventPublisherFactory {
    ...
    /**
     * Gets the appropriate event publisher for the specified publisher type.
     * <p>
     * This method returns the appropriate {@link EventPublisher} implementation for the
     * specified {@link com.catalis.common.core.messaging.annotation.PublisherType}. It first
     * checks if the publisher is available and properly configured. If not, it returns null.
     * <p>
     ...
     * <ol>
     *   <li>Get the base publisher for the specified type</li>
     ...
     *   <li>Return the enhanced publisher</li>
     * </ol>
     * <p>
    ...
    public EventPublisher getPublisher(PublisherType publisherType) {
        ...
        EventPublisher publisher = resilientFactory.createResilientPublisher(
                basePublisher,
                publisherType.name().toLowerCase()
        );
