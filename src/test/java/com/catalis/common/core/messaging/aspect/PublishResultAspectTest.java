...
public class PublishResultAspectTest {
    ...
    void setUp() throws Exception {
        ...
        lenient().when(serializerFactory.getSerializer(any(), any())).thenReturn(mock(com.catalis.common.core.messaging.serialization.MessageSerializer.class));
    }
    ...
    void shouldPublishSynchronousResult() throws Throwable {
        ...
        // verify(eventPublisher).publish(eq("test-topic"), eq("test.event"), eq(expectedResult), any(), any(com.catalis.common.core.messaging.serialization.MessageSerializer.class));
    }
